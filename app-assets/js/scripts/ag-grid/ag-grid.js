...
$(document).ready(function () {
  ...
  var columnDefs = [
    {
      ...
      field: "firstname",
      editable: true,
      cellEditor: 'select', // Another option for popup is agPopupSelectCellEditor
      cellEditorParams: { values: ['Ade', 'Bimpe'] },
      sortable: true,
      width: 175,
      filter: true,
  ...
  var gridOptions = {
    ...
    onCellEditingStarted: function (params) {
      // node, data, value, column, colDef, context, api, columnApi, rowPinned, params, type, rowIndex,
    ...
    onCellValueChanged: function (params) {
      console.log(
        'onCellValueChanged: ' + params.colDef.field + ' = ' + params.newValue
      );
    },
